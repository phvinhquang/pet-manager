...
// CODE CŨ, 3 HÀM HIỂN THỊ BREED RIÊNG BIỆT, BẢN DEPLOY THÌ XÓA ĐI
///////////////////////////////////
//Hàm hiển thị giống chó hoặc mèo theo type
// function showCatBreeds() {
//   //Lọc các giống mèo
//   const catBreeds = breedArr.filter(function (obj) {
//     if (obj.type === "Cat") {
//       return obj;
//     }
//   });

//   //Hiển thị các giống  mèo
//   catBreeds.forEach((obj, i) =>
//     breedInput.insertAdjacentHTML(
//       "beforeend",
//       `<option>${catBreeds[i].breed}</option>`
//     )
//   );
// }
...
//   //Lọc các giống chó
//   const dogBreeds = breedArr.filter(function (obj) {
//     if (obj.type === "Dog") {
//       return obj;
//     }
//   });

//   // Hiển thị các giống chó
//   dogBreeds.forEach((obj, i) =>
//     breedInput.insertAdjacentHTML(
//       "beforeend",
//       `<option>${dogBreeds[i].breed}</option>`
//     )
//   );
// }

//Hàm hiển thị tất cả Breed
